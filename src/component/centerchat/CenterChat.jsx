          ...
          <div className="centerbox">
              ...
              <div className="center-top">
                <div className="imgleft">
                  ...
                  <div className="pl-2 centerin">
                    <span>{user.name}</span>
                    {onlineUser?.find((val) => val._id === user._id) ? (
                      <small>Online</small>
                    ) : (
                      <small>Offline</small>
                    )}
                ...
                <div className="logut pr-3">
                  <button
                    className={downshow ? 'downbtnone' : 'downbtn'}
                    onClick={download}
                  >
                    {' '}
            ...
            <form onSubmit={handleSubmit}>
              <div className="bottom-center">
                ...
                <button type="submit" className="btn btn-success ml-1 mr-1">
                    ...
                    <div class="modal-content">
                      ...
                      <div class="modal-footer">
                        <button
                          type="button"
                          disabled={loading}
                          class={loading ? 'btn btn-dark btnn' : 'btn btn-dark'}
                          onClick={postSub}
                        >
                          Send Now
                        </button>
