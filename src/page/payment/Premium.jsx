          ...
          <div className="row">
            <div className="col-md-6 col-12 mx-auto ">
              ...
              <ul className="text-white p-3">
                <li className="p-2">
                  If You are a Premium user you will get Text Notification about
                  any chat if you are not online in your platform.
                </li>
                <li className="p-2">
                  If you want to be a Premium user you have to pay ₹50.00 per
                  month.
                </li>
                <li className="p-2">
                  When you exceed you dateline we will inform you about Premium
                  Feature in you Profile Section
                </li>
                <li className="p-2">
              ...
              <div className="card p-3">
                ...
                <form className="text-dark " onSubmit={onSub}>
                  ...
                  <div className="text-center">
                    <button className="btn btn-info" disabled={show}>
                      Buy Now
                    </button>
                  </div>
                </form>
